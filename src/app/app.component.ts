  ...
  public data: Object[] = [
    {
      ...
      GM: 'ATE',
      Subestação: 'Aymorés',
      Inicio: new Date('2017-01-01'),
      Termino: new Date('2021-01-01'),
    ...
    },
    {
      ...
      GM: 'EDTE',
      Subestação: 'Aymorés',
      Inicio: new Date('2021-01-01'),
      Termino: new Date('2023-01-01'),
      Resumo: 'Construção da nava LT',
      Comentarios: 5
    },
    {
